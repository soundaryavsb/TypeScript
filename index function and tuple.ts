...
//? Readonly array - the readonlyarray is used to prevent an array from any kind modification.

//! only for an array the readonly property is provided in two ways - 

// the first approach of providing readonly array- 

// let demo : readonly number[] = [10,20,30]
// demo[1] = 100
// demo.push(250)
// demo.pop()
// console.log(demo);

// the second approach of providing the readonlyarray - 

// let demo : ReadonlyArray <number> = [10,20,30]
// demo = [101,201,301,401]
// console.log(demo);

// let employee : {
//     emp_id : ReadonlyArray<string>,
//     emp_name : string
// }[]
// employee = [
//     {
...
//     },{
//         emp_id : ["1002"],
//         emp_name : "Shilpashree"
//     },{
//         emp_id : ["1003"],
//         emp_name : "Vijay"
//     }
// ]
// employee[0].emp_id = "1004"
...
//? tuple - Tuple is a special datatype in typescript which is used to store a collection of elements.Here the sequence of the elements matter the most.
//! syntax - declaraction_type_of_variable variable : [datatype]  = [values]

// let data : [string,number,boolean,string] = ["Typescript",7,true,"playwright"]
// console.log(data);
...
// let data : [string?, string?, boolean?,number?] = ["a","b",,50]
// console.log(data);

//? tuple with a functional parameter - 

// function demo(a:[number,number,boolean]){
    // return [a[0]*10,a[1]*5]                  //! --> using array
    // return {                                    //! --> using object
    //     p : a[0]*10,
    //     q : a[1]*5
    // }
// }
// console.log(demo([10,10,false]));

//? tuple with an array - 

// let data_arra : [number,number[]][] = [
//     [10,[1,2,3,4,5,6]],[10,[1,2]],[20,[1,2]],[10,[1,2]]
// ]
// console.log(data_arra);

//? 4. create a function that returns a tuple (status, order_id)

// function order(order_detail:[string,number]){
//     return `The order details are like : order status - ${order_detail[0]} and order id - ${order_detail[1]}.`
// }
// console.log(order(["successful",1504]));