...
let numfil:number[]=[10,20,30,40];
let numfilter:number[]=numfil.filter((n)=>{
return n>25;
})
...
let numredu:number[]=[10,20,30,40];
let numreduce:number=numredu.reduce((a,c)=>{
    return a+c;
});
...
//* string+number
function demofun(a:string,b:number){
    console.log(a+b);
...
//* number+string
function demofun3(a:number,b:string){
    console.log(a+b);
}
demofun3(1,"st Rank");

//* string+string
function demofun2(a:string,b:string){
    console.log(a+b);
}
demofun2("Score ","here");
...
//* string+boolean
function demofun5(a:string,b:boolean){
    console.log(a+b);
}
demofun5("Hello",true);
//* Note: 
...
let datatuple1:[string,number,boolean,string]= ["TypeScript",7,true,"PlayWright"]
console.log(datatuple1);

//? tuple accessing and updating:
let datatuple2:[string,number,boolean,string]= ["TypeScript",7,true,"PlayWright"]
// datatuple2[1]="write" ;//* Error: cannot assign a different data value
console.log(datatuple2);

//?tuple with an optional parameter:
let datatuple3:[string?,string?,boolean?,number?];
...
function demoFunPara1(a:[number,number,boolean]){
...
function demoFunPara2(a:[number,number,boolean]){
return {
    k1:a[0],
    k2:a[0]*10,
    k3:a[1]-10,
...
function demoTupleFun(a:[number,number[]]){
